  ...
  internal = rec {
    ...
    crates = {
      ...
      "cron" = rec {
        ...
        version = "0.15.0";
        edition = "2021";
        sha256 = "0h0ps16jl0fx3n89dm8r818dh3fkdc84a69apik7nl22yzxx6xsq";
        authors = [
      ...
      "opencode-zen" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "7b02e9e8a86005f753c8b33d1cde458510d39560";
          sha256 = "1lmn36jn0zgpsk3m9mbvlnzh3p9c7bczxr9h36mwjj7hvqvva7sj";
        };
      ...
      "pleme-tend" = rec {
        ...
        features = {
          "default" = [ "operator" ];
          "operator" = [ "dep:kube" "dep:k8s-openapi" "dep:schemars" "dep:futures" "dep:tracing" "dep:tracing-subscriber" "dep:petgraph" "dep:rnix" "dep:rowan" "dep:rand" "dep:prometheus" "dep:hyper" "dep:hyper-util" "dep:http-body-util" "dep:samba" "dep:async-nats" "dep:uuid" ];
        };
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "brotli" "charset" "cookies" "default" "default-tls" "gzip" "h2" "http2" "json" "multipart" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "system-proxy" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.14";
      ...
      "rowan" = rec {
        ...
        version = "0.15.18";
        edition = "2021";
        sha256 = "021j1mf18ighc5cfcmyqm08rq1sqsiqnf0b4hn60rk68bw4hkxb2";
        authors = [
          "Aleksey Kladov <aleksey.kladov@gmail.com>"
        ];
        dependencies = [
      ...
      "samba" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "3696ed2ab16b7bfdd7614bb1ccad86e71a78df4a";
          sha256 = "11qax96kbjzdfhf6n9brjx9970xgz3qbmvi3bsxs3ylzq5c0ha02";
        };
        dependencies = [
          {
            name = "async-nats";
      ...
      "shigoto-budget" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8d6cb24b27a6d127fba9af1f74ba0470ed89fea4";
          sha256 = "1648i5gpy465ndya7rjkmihvrn2kip0wi0mgz0pv3qj2xrhwx495";
        };
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "0cda5c4bb596d1e9b816e16be8a3291ffb7a85f9";
          sha256 = "0p34im3qyj1b0akjsyg5bvg4xcsi9n0n7y1cmahr41p6mbxk7sh4";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "todoku" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "785b265c75c9dbacbbf195d15bbd1da8b56ce4be";
          sha256 = "0jli9va27418z60b11vckm50f10w7c9lbx2g3iyszj2xqdgxh33q";
        };
        dependencies = [
          {
            name = "async-trait";
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "auth" "base64" "decompression-br" "decompression-gzip" "default" "follow-redirect" "futures-core" "futures-util" "map-response-body" "mime" "tokio-util" "tower" "trace" "tracing" "validate-request" ];
      };
      "tower-layer" = rec {
      ...
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Globalization" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Console" "Win32_UI" "Win32_UI_Shell" "default" ];
      };
