    ...
    crates = {
      ...
      "opencode-zen" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5c065b2f0ed6d187e590b4968e7f20dcf4040be4";
          sha256 = "08kshy3p4zlaxk9z7yz07qiz76c4ssyy5zjrkjsaqs4yvm3mrmmm";
        };
      ...
      "samba" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "aa83abd34975786167510407f16421bcb33c7b4b";
          sha256 = "1cqgnm6y2v354q299f240w42a097nr7ffkk3mrmdv0n8lcpac3pq";
        };
        dependencies = [
          {
            name = "async-nats";
      ...
      "shigoto-budget" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "sha256-TrXcjALBoBynwmKMHeVAwgJcL/u91rq7l+TCbLplkvY=";
        };
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "90773680617d4e9fc976fd322d7ecd1bcd2e7071";
          sha256 = "0dzn4axfx4asampkini6wv6j80mkiy34z44l9n4kx3kfjwai5bg1";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "windows-sys 0.52.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_System" "Win32_System_Console" "Win32_System_Threading" "default" ];
      };
